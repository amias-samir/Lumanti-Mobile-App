...
package np.com.naxa.lumanti.database;
...
/**
 * We've taken this siteName Android's SQLiteOpenHelper. However, we can't appropriately lock the
        ...
        try {
            ...
            try {
                ...
                if (!cardstatus.equals(Environment.MEDIA_MOUNTED)) {
                    throw new RuntimeException("SD card is unmounted");
                } else {
                    throw e;
                }
            }
            ...
            if (db.getVersion() != mNewVersion) {
                throw new SQLiteException("Can't upgrade read-only database siteName version "
